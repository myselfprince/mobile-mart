    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-100 p-6 rounded-lg">
          <img className="h-40 rounded w-full object-cover object-center mb-6" src="/images/mobile.jpg" alt="content" />
          <h3 className="tracking-widest text-indigo-500 text-xs font-medium title-font">Mobile Phone</h3>
          <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Samsung</h2>
          <p className="leading-relaxed text-base">Sleek, powerful, and packed with innovation. Your pocket-sized tech essential</p>
        </div>
      </div>
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-100 p-6 rounded-lg">
